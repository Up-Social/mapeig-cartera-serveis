...
begin
 ...
 update evidence_chunks set content='Second fictitious evidence',content_hash='second' where source_document_id=doc;
 insert into pipeline_runs default values returning id into r;
 ...
 if version_count<>2 then raise exception 'Expected two document versions, got %',version_count;end if;
